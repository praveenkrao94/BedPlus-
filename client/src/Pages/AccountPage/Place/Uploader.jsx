                  ...
                  <div className='mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                  {
                    addedPhotos.length >0 && addedPhotos.map((link, index)=>{
                      return (
                        ...
                        <button onClick={ev => removePhoto(ev,link)} className=" cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-60 rounded-xl p-2">
                        ...
                        {/* edit  */}
                        <button onClick={ev=> selectAsMainphoto(ev,link)} className=" cursor-pointer absolute bottom-1 left-1 text-white bg-black bg-opacity-60 rounded-xl p-2">
                          {link === addedPhotos[0] && (
